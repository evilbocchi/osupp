...
- Scores in the "Best Performance" section on user profiles may be **out of order or not be visible at all**.
...
This will bring everything back in line with expectations.
